...
## Prelab Activity 4.1 — Definitions

### Types of Tissues

- Epithelial — Tissue that covers body surfaces, lines cavities, and forms glands.
- Connective — Tissue that supports, binds, and protects other tissues.
- Muscular — Tissue specialized for contraction and movement.
- Nervous — Tissue that transmits electrical impulses for communication.
...
- Stratified squamous (keratinized/nonkeratinized) — Multiple layers for protection from abrasion.
- Simple cuboidal — Single layer of cube-shaped cells; secretion and absorption.
- Stratified cuboidal/columnar — Rare; protection in ducts of glands.
- Simple columnar — Single layer of tall cells; absorption and secretion.
- Pseudostratified columnar epithelium — Appears multilayered; secretion and movement of mucus.
- Transitional epithelium — Stretchable epithelium in urinary organs.
...
### Surfaces
- Apical — Surface facing lumen or free space.
...
- Cartilage — Supportive connective tissue with chondrocytes in lacunae.
- Areolar connective tissue — Loose connective tissue surrounding organs.
- Hyaline cartilage — Smooth cartilage found in joints and trachea.
- Adipose tissue — Fat storage tissue.
- Fibrocartilage — Strong cartilage with thick collagen fibers.
- Elastic cartilage — Flexible cartilage found in ear and epiglottis.
- Regular dense connective tissue — Parallel collagen fibers in tendons and ligaments.
- Irregular dense connective tissue — Irregular collagen arrangement in dermis.
- Bone — Mineralized connective tissue for support and protection.
- Blood — Fluid connective tissue transporting materials.
...
- Elastin fibers — Stretchable fibers allowing recoil.
- Extracellular matrix — Ground substance plus fibers surrounding cells.
- Cells — Living components of connective tissue.
    - Fibroblasts — Produce fibers and matrix.
    - Adipocytes — Fat-storing cells.
    - Chondrocytes — Cartilage cells.
- Lacuna — Small cavity containing cartilage or bone cells.

---

# LAB ACTIVITY 4.1 — Epithelial Tissue Identification

| Figure | Tissue Name | Location | Function |
|---|---|---|---|
| Figure 4.3 | Simple squamous epithelium | Alveoli of lungs; kidney glomeruli | Diffusion and filtration |
| Figure 4.4 | Simple cuboidal epithelium | Kidney tubules; glands | Secretion and absorption |
| Figure 4.5 | Simple columnar epithelium | Digestive tract | Absorption and secretion |
| Figure 4.6 | Pseudostratified ciliated columnar epithelium | Trachea; respiratory tract | Secretion and movement of mucus |
| Figure 4.7 | Transitional epithelium | Urinary bladder | Stretching and distension |
| Figure 4.8 | Stratified squamous epithelium | Skin; mouth; esophagus | Protection from abrasion |
...
|---|---|---|
| Simple squamous | 400x | Lung alveoli; kidney glomeruli |
| Simple cuboidal | 400x | Kidney tubules; glands |
| Simple columnar | 400x | Small intestine; stomach |
| Transitional | 400x | Urinary bladder |
| Stratified squamous | 400x | Skin; oral cavity; esophagus |

---

# LAB ACTIVITY 4.3 & 4.4 — Connective Tissue Identification

| Tissue | Magnification | Location | Function |
|---|---|---|---|
| Areolar | 400x | Under epithelia; around organs | Support and cushioning |
| Adipose | 400x | Hypodermis; around kidneys | Energy storage and insulation |
| Dense regular connective tissue | 400x | Tendons; ligaments | Strong attachment |
| Blood | 400x | Blood vessels | Transport |
| Hyaline cartilage | 400x | Trachea; joints | Support and reduced friction |
| Fibrocartilage | 400x | Intervertebral discs | Shock absorption |
| Elastic cartilage | 400x | Ear; epiglottis | Flexible support |
| Bone | 400x | Skeleton | Support and protection |
...
### Examples
- Simple squamous epithelium is thin for diffusion in lungs.
- Stratified squamous epithelium protects against abrasion in skin.
- Simple cuboidal epithelium functions in secretion and absorption in kidney tubules.
- Simple columnar epithelium absorbs nutrients in intestines.

---

## Major Tissue Types

| Tissue Type | Characteristics | Example Location |
|---|---|---|
| Epithelial | Covers and lines surfaces | Skin |
| Connective | Supports and binds tissues | Bone |
| Muscle | Contracts for movement | Skeletal muscles |
| Nervous | Conducts impulses | Brain and spinal cord |
...
|---|---|---|
| Fig. 4.10 | Simple squamous epithelium | Alveoli; kidney glomeruli |
| Fig. 4.11 | Simple cuboidal epithelium | Kidney tubules |
| Fig. 4.12 | Simple columnar epithelium | Intestines |
| Fig. 4.13 | Transitional epithelium | Urinary bladder |
| Fig. 4.14 | Stratified squamous epithelium | Skin; esophagus |
| Fig. 4.15 | Pseudostratified ciliated columnar epithelium | Trachea |
...
- Supports organs and surrounds blood vessels
...
- Found in trachea and joints

## Elastic Cartilage
- Flexible cartilage with elastin fibers
...
## Bone Tissue
- Contains osteons and osteocytes
- Provides support, mineral storage, and protection

---

# QUICK REVIEW OF MUSCLE TISSUES

| Muscle Type | Characteristics | Location |
|---|---|---|
| Skeletal muscle | Striated; voluntary; multinucleated | Attached to bones |
| Cardiac muscle | Striated; involuntary; intercalated discs | Heart |
| Smooth muscle | Nonstriated; involuntary | Hollow organs |

---

# QUICK REVIEW OF NERVOUS TISSUE
...
Epithelial — Tissue that covers body surfaces, lines cavities, and forms glands.  
Connective — Tissue that supports, binds, and protects other tissues; contains cells, fibers, and matrix.  
Muscular — Tissue specialized for contraction and movement.  
Nervous — Tissue that transmits electrical impulses for communication and control.

Epithelial Tissues:

Simple squamous — Single layer of flat cells; allows diffusion and filtration.  
Stratified squamous (keratinized/nonkeratinized) — Multiple layers; protection from abrasion; keratinized in skin, nonkeratinized in mouth/esophagus.  
Simple cuboidal — Single layer of cube‑shaped cells; secretion and absorption.  
Stratified cuboidal/columnar – rare — Protection; found in ducts of glands.  
Simple columnar — Single layer of tall cells; absorption and secretion; may contain goblet cells.  
Pseudostratified columnar epithelium — Appears multilayered but is one layer; often ciliated; secretion and movement of mucus.  
Transitional epithelium — Stratified; cells change shape; found in urinary bladder.

Epithelial features:

Simple — One layer of cells.  
Stratified — Multiple layers of cells.  
Apical — Surface facing the lumen or free space.  
Basal — Surface attached to basement membrane.  
...
Cartilage — Supportive connective tissue with chondrocytes in lacunae.  
Areolar connective tissue — Loose CT with fibroblasts, collagen, elastin; wraps organs.  
Hyaline cartilage — Smooth, glassy cartilage; ends of long bones, trachea.  
Adipose tissue — Fat storage tissue; insulation and energy reserve.  
Fibrocartilage — Strong cartilage with thick collagen; intervertebral discs.  
...
Irregular dense connective tissue — Irregular collagen fibers; dermis.  
Bone — Mineralized connective tissue; support and protection.  
Blood — Fluid connective tissue; transport of gases, nutrients, wastes.

Connective Tissue Features:

Collagen fibers — Strong, thick fibers providing tensile strength.  
Elastin fibers — Stretchy fibers allowing recoil.  
Extracellular matrix — Ground substance + fibers surrounding cells.  
Cells — Living components of CT.  
Fibroblasts — Produce fibers and matrix.  
Adipocytes — Store fat.  
Chondrocytes — Cartilage cells in lacunae.  
Lacuna — Small cavity housing a cell (bone or cartilage).
...
(Figure numbers correspond to typical textbook images.)

Figure 4.3  
Name: Simple squamous epithelium  
Location: Alveoli of lungs; kidney glomeruli  
...
===============================
Lab Activity 4.2  
Microscope Work (Typical Answers)
===============================
...
Simple columnar  
Magnification: 400x  
Location: Small intestine; stomach lining
...
Stratified squamous  
Magnification: 400x  
Location: Skin; oral cavity; esophagus

===============================
Lab Activity 4.3 & 4.4  
...
Function: Cushions organs; provides support

Adipose  
Magnification: 400x  
Location: Hypodermis; around kidneys  
Function: Energy storage; insulation

Dense regular connective tissue  
Magnification: 400x  
Location: Tendons; ligaments  
Function: Strong attachment; resists pulling in one direction
...
Hyaline cartilage  
Magnification: 400x  
Location: Trachea; ends of long bones  
...
Epithelium classification:  
1) Number of layers (simple vs. stratified)  
2) Cell shape (squamous, cuboidal, columnar)
