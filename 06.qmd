...
#### Skeleton
- Axial skeleton: Forms the central axis of the body including the skull, vertebral column, and thoracic cage.
...
- Epiphysis: Expanded end of a long bone containing spongy bone and red marrow.
- Diaphysis: Shaft of a long bone.
- Compact bone: Dense outer bone tissue that provides strength.
- Spongy bone: Porous bone tissue containing trabeculae and red marrow.
- Hyaline (articular) cartilage: Smooth cartilage covering the ends of bones to reduce friction.
...
- Medullary cavity: Hollow cavity inside the diaphysis containing marrow.
- Yellow marrow: Fat-storing marrow found in the medullary cavity.
...
| Matrix | Nonliving material surrounding bone cells |
| Collagen fibers | Protein fibers providing flexibility and tensile strength |
| Calcium phosphate | Mineral salt that hardens bone |
...
| Term | Definition |
|---|---|
| Long bones | Longer than wide; function as levers |
| Short bones | Cube-shaped bones providing stability |
| Flat bones | Thin bones protecting organs |
...
| Number | Name of bone or region | Division |
|---|---|---|
| 1 | Cranium | Axial |
| 2 | Mandible | Axial |
...
|---|---|---|
| Long | Cylindrical; longer than wide | Femur, Humerus |
| Short | Cube-shaped | Carpals, Tarsals |
| Flat | Thin and curved | Sternum, Scapula |
| Irregular | Complex shape | Vertebrae, Coxal bone |
| Sesamoid | Small and round | Patella, Pisiform |

--------------------------------------------------

## Lab Activity 6.3

### Major anatomical differences between compact and spongy bone

- Compact bone is dense, solid, and forms the outer layer of bone.
- Spongy bone is porous, contains trabeculae, and is found inside bones where it houses red marrow.

--------------------------------------------------

## Post Lab Activity 6.1

### Crossword Puzzle – Bone Features
...
### Crossword Puzzle – Bone Structure
...
| Statement | Answer |
|---|---|
| ______ cartilage covers ends of long bones. | Articular |
| Skeletal cartilage is enclosed by the ______. | Perichondrium |
| The bones of the limbs, shoulders, and hips make up the ______ skeleton. | Appendicular |
| Cancellous bone is found in the ______ of long bones. | Epiphyses |
| ______ is found in the medullary cavity and is composed of fat. | Yellow marrow |
| Articular cartilage is composed of ______. | Hyaline cartilage |
| The inner surface of bone is covered by the ______. | Endosteum |
| The tubular shaft of a long bone is the ______. | Diaphysis |
| The skull, rib cage, and vertebral column make up the ______ skeleton. | Axial |
| The line separating the diaphysis and epiphysis is the ______. | Epiphyseal line |

--------------------------------------------------

## Figure 6.19 Labeling
...
- Medullary cavity
- Red marrow
- Yellow marrow# **Skeletal Terms, Bone Histology, and Microanatomy**
